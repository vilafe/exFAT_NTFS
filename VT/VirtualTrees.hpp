...
public:
	/* TCustomControl.Destroy */ inline __fastcall virtual ~TVirtualTreeHintWindow(void) { }
...
public:
	...
	void __fastcall DrawDropMark(void);
};
...
protected:
	...
	void __fastcall SetHoverIndex(TColumnIndex index);
	...
	__property TColumnIndex HoverIndex = {read=FHoverIndex, write=FHoverIndex, nodefault};
	__property TColumnIndex DownIndex = {read=FDownIndex, write=FDownIndex, nodefault};
...
public:
	...
	__property TColumnIndex DragIndex = {read=FDragIndex, write=FDragIndex, nodefault};
	__property bool DropBefore = {read=FDropBefore, write=FDropBefore, nodefault};
	__property TColumnIndex DropTarget = {read=FDropTarget, write=FDropTarget, nodefault};
	...
	__property TColumnIndex TrackIndex = {read=FTrackIndex, write=FTrackIndex, nodefault};
};
...
private:
	...
	int __fastcall GetRestoreSelectionColumnIndex(void);
...
public:
	...
	virtual void __fastcall StyleChanged(void);
...
public:
	...
	TVTOffsets Offsets;
	int VAlign;
	void __fastcall AdjustImageCoordinates(void);
};
...
private:
	...
	bool __fastcall GetVclStyleEnabled(void);
...
protected:
	...
	void __fastcall ClearDragManager(void);
	...
	void __fastcall TrySetFocus(void);
...
public:
	...
	void __fastcall ClearLink(void);
	void __fastcall ClearRefLink(void);
...
public:
	...
	__property TCustomVirtualStringTree* Tree = {read=FTree};
private:
...
private:
	...
	bool __fastcall IsDefaultTextStored(void);
